...
<body>
	...
	<div class="content">
		<form:form action="/admin/substation/edit/${ substation.id }" method="post"
			modelAttribute="editSubStation">
			<input type="hidden" name="_method" value="put">
			<div class="form-group">
				<form:label path="name">Name:</form:label>
				<form:errors path="name"></form:errors>
				<form:input class="form-control" path="name"
					value="${substation.name }"></form:input>
			</div>
			<div class="form-group">
				<form:label path="station">Stations:</form:label>
				<form:errors path="station"></form:errors>
