...
<body>
	...
	<div class="content">
		<form:form action="/admin/stations/new" method="post"
			modelAttribute="newStation">
			...
			<div class="form-group">
				...
				<form:input class="form-control" path="location"></form:input>
			</div>
			<div class="form-group">
				<form:label path="lat">lat:</form:label>
				<form:errors path="lat"></form:errors>
				<form:input class="form-control" path="lat"></form:input>
			</div>
			<div class="form-group">
				<form:label path="lng">lng:</form:label>
				<form:errors path="lng"></form:errors>
				<form:input class="form-control" path="lng"></form:input>
			</div>
